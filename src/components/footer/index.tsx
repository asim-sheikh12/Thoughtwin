      ...
      <div className='border-solid border-t-[#d6d6d6] border-t box-border flex px-24 pt-9 '>
        <div className='px-10 flex-grow  flex-1'>
          ...
          <div>
            ...
            <p className='font-Formular not-italic font-normal tracking-wide text-sm leading-5 text-gray-600 capitalize cursor-pointer hover:text-black '>
        ...
        <div className='flex-1'>
          ...
          <ul>
            <li className='font-Formular not-italic font-normal tracking-wider text-sm leading-5 text-gray-600 capitalize cursor-pointer mt-3 hover:text-black '>
              <Link href='/'>Python Developers</Link>
            </li>
            <li className='font-Formular not-italic font-normal tracking-wider text-sm leading-5 text-gray-600 capitalize cursor-pointer my-3 hover:text-black '>
        ...
        <div className='flex-1'>
          ...
          <p className='font-Formular not-italic font-normal tracking-wider text-sm leading-5 text-gray-600 capitalize my-3 hover:text-black '>
            Feel free to drop us a note:
          </p>
          <h4 className='font-Formular text-[#4f4f4f] font-bold py-2'>
            For Sales & Business
          </h4>
          <p className='font-Formular not-italic font-normal tracking-wide text-sm leading-5 text-gray-600 capitalize cursor-pointer my-3 hover:text-black '>
            India: +91 6265525569
          </p>
          <h4 className='font-Formular text-[#4f4f4f] font-bold py-2'>
            For Job
          </h4>
          <p className='font-Formular not-italic font-normal tracking-wider text-sm leading-5 text-gray-600 capitalize cursor-pointer my-3 hover:text-black '>
            India: +91 9977069348
          </p>
        </div>
      </div>
      <hr />
      <div className='box-border text-center tracking-wider'>
